        ...
        modes: {
            single: function (selectionModel) {
                ...
                if (selectionModel.hasVertical()) {
                    matchers.register(
                        { type: 'keydown', which: 38, ctrlKey: false, shiftKey: false, metaKey: false, hasItem: false },
                        { type: 'keydown', which: 40, ctrlKey: false, shiftKey: false, metaKey: false, hasItem: false }, function (event, item) {
                ...
                if (selectionModel.hasHorizontal()) {
                    matchers.register(
                        { type: 'keydown', which: 37, ctrlKey: false, shiftKey: false, metaKey: false, hasItem: false },
                        { type: 'keydown', which: 39, ctrlKey: false, shiftKey: false, metaKey: false, hasItem: false }, function (event, item) {
                        var first = selectionModel.firstItem();
                        selectionModel.selectItem(first);
                        selectionModel.anchor(first);
                    });
            ...
            multi: function (selectionModel) {
                ...
                if (selectionModel.hasHorizontal()) {
                    matchers.register(
                        { type: 'keydown', which: 37, ctrlKey: false, shiftKey: false, metaKey: false, hasItem: false },
                        { type: 'keydown', which: 49, ctrlKey: false, shiftKey: false, metaKey: false, hasItem: false }, function (event, item) {
                        var first = selectionModel.firstItem();
                        selectionModel.selectItem(first);
                        selectionModel.anchor(first);
                    });
