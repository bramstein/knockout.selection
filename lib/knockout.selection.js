    ...
    ko.bindingHandlers.selection = {
        init: function(element, valueAccessor, allBindingsAccessor, viewModel, bindingContext) {
            ...
            if (bindingValue.data) {
                ...
                if (bindingValue.single === true) {
                    single = true;
                }

                if (bindingValue.properties) {
                    if (bindingValue.properties.selected) {
                        properties.selected = bindingValue.properties.selected;
                    }
                    if (value.properties.focused) {
                        properties.focused = bindingValue.properties.focused;
                    }
                }
            } else {
                selection = value;
